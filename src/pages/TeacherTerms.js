  ...
  return (
    <div className="bg-[#E4CFFF]">
        ...
        <div className="rounded-3xl p-20 bg-white bg-opacity-50 gap-4 justify-center mx-auto my-100 w-7/12 overflow-y-auto h-screen ">
            <div className="text-2xl font-montserrat mx-auto ">
                ...
                <p className="justify-center">
                    <b>Welcome to Sola!</b><br/>
                    <br/>
                    These terms and conditions outline the rules and regulations for the use of Sola's Website, located at sola.com.<br/>
                    <br/>
                    By accessing this website we assume you accept these terms and conditions. Do not continue to use Sola if you do not agree to take all of the terms and conditions stated on this page.<br/>
                    The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: “Client”, “You” and “Your” refers to you, the person log on this website and compliant to the Sola's terms and conditions. “Sola”, “Ourselves”, “We”, “Our” and “Us”, refers to Sola. “Party”, “Parties”, or “Us”, refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client's needs in respect of provision of the Sola's stated services, in accordance with and subject to, prevailing law of Netherlands. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.<br/>
                    <br/>
                    <b>Cookies</b><br/>
                    We employ the use of cookies. By accessing Sola, you agreed to use cookies in agreement with the Sola's Privacy Policy.<br/>
                    <br/>
                    ...
                    <br/>
                    <b>License</b><br/>
                    Unless otherwise stated, Sola and/or its licensors own the intellectual property rights for all material on Sola. All intellectual property rights are reserved. You may access this from Sola for your own personal use subjected to restrictions set in these terms and conditions.<br/>
                    <br/>
                    You must not:<br/>
                    - Republish material from Sola<br/>
                    - Sell, rent or sub-license material from Sola<br/>
                    - Reproduce, duplicate or copy material from Sola<br/>
                    - Redistribute content from Sola<br/>
                    <br/>
                    Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Sola does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Sola,its agents and/or affiliates. Comments reflect the views and opinions of the person who posts their views and opinions. To the extent permitted by applicable laws, Sola shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
                    <br/>
                    Sola reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.
                    <br/>
                    ...
                    <br/>
                    You hereby grant Sola a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.<br/>
                    <br/>
                    ...
                    - System wide Accredited Businesses except soliciting non-profit organizations, charity shopping malls, and charity fundraising groups which may not hyperlink to our Website.<br/>
                    ...
                    We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Sola; and (d) the link is in the context of general resource information.<br/>
                    <br/>
                    ...
                    <br/>
                    If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an email to Sola. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.<br/>
                    <br/>
                    ...
                    <br/>
                    No use of Sola's logo or other artwork will be allowed for linking absent a trademark license agreement.<br/>
                    <br/>
                    <b>iFrames</b><br/>
                    Without prior approval and written permission, you may not create frames around our Web Pages that alter in any way the visual presentation or appearance of our Website.<br/>
                    <br/>
        ...
        <div className="justify-center flex relative">
            <button onClick={handleClick} className="bg-[#D2AFFF] font-gaegu text-4xl px-24 py-5 my-16 rounded-full cursor-pointer hover:bg-[#6619ff] transition duration-200">I have read the terms and agreements</button>
        </div>
